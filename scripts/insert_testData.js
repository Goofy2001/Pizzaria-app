...
function insertTestDataGpsTracking() {
    return pool.query(`
        ...
        VALUES
            (2, 8,  50.8490, 4.3480, '2025-03-01 15:12:00'),
            (2, 8,  50.8505, 4.3465, '2025-03-01 15:15:00'),
            (2, 8,  50.8520, 4.3450, '2025-03-01 15:18:00'),
            (4, 18, 51.2050, 4.4210, '2025-03-02 15:07:00'),
            (4, 18, 51.2065, 4.4225, '2025-03-02 15:10:00'),
            (4, 18, 51.2080, 4.4240, '2025-03-02 15:13:00')
    `);
}
